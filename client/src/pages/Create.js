									...
									<div className="grid grid-cols-6 gap-6">
										<div className="col-span-6 sm:col-span-3">
											...
											<input
												...
												className="mt-1 focus:ring-indigo-500 py-2 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-700 rounded-md"
											/>
										</div>
										...
										<div className="col-span-6 sm:col-span-3">
											...
											<input
												...
												name="tags"
												value={create.tags}
												onChange={(e) => setCreate({ ...create, tags: e.target.value })}
												id="tags"
										...
										<div className="col-span-6 sm:col-span-3">
											...
											<input
												...
												onChange={(e) => setCreate({ ...create, upload_date: e.target.value })}
												id="upload_date"
										...
										<div className="col-span-6">
											...
											<input
												...
												onChange={(e) => setCreate({ ...create, license: e.target.value })}
												className="mt-1 focus:ring-indigo-500 py-2 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
											/>
										</div>
										...
										<div className="col-span-6 sm:col-span-3 lg:col-span-2">
											...
											<input
												...
												onChange={(e) => setCreate({ ...create, printer: e.target.value })}
												className="mt-1 focus:ring-indigo-500 py-2 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
											/>
										</div>
										...
										<div className="col-span-6 sm:col-span-3 lg:col-span-2">
											...
											<input
												...
												onChange={(e) => setCreate({ ...create, printer_brand: e.target.value })}
												className="mt-1 focus:ring-indigo-500 py-2 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
											/>
										</div>
										<div className="col-span-6 sm:col-span-3 lg:col-span-2">
											<label htmlFor="rafts" className="block text-sm font-medium text-gray-700">
												Rafts
											</label>
											<input
												type="text"
												...
												id="rafts"
												value={create.rafts}
												onChange={(e) => setCreate({ ...create, rafts: e.target.value })}
												className="mt-1 focus:rin
                        g-indigo-500 focus:border-indigo-500 py-2 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
											/>
										</div>
										<div className="col-span-6 sm:col-span-3 lg:col-span-2">
											<label htmlFor="supports" className="block text-sm font-medium text-gray-700">
												Supports
											</label>
											<input
												type="text"
												...
												onChange={(e) => setCreate({ ...create, supports: e.target.value })}
												className="mt-1 focus:rin
                        g-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
											/>
										</div>
										<div className="col-span-6 sm:col-span-3 lg:col-span-2">
											<label
											...
											<input
												...
												onChange={(e) => setCreate({ ...create, resolution: e.target.value })}
												className="mt-1 focus:rin
                        g-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
											/>
										</div>
										<div className="col-span-6 sm:col-span-3 lg:col-span-2">
											...
											<input
												...
												id="infill"
												value={create.infill}
												onChange={(e) => setCreate({ ...create, infill: e.target.value })}
												className="mt-1 focus:rin
                        g-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
											/>
										</div>
										<div className="col-span-6 sm:col-span-3 lg:col-span-2">
											...
											<input
												...
												onChange={(e) => setCreate({ ...create, filament_brand: e.target.value })}
												className="mt-1 focus:rin
                        g-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
											/>
										</div>
										<div className="col-span-6 sm:col-span-3 lg:col-span-2">
											...
											<input
												...
												onChange={(e) => setCreate({ ...create, filament_color: e.target.value })}
												className="mt-1 focus:rin
                        g-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
											/>
										</div>
										<div className="col-span-6 sm:col-span-3 lg:col-span-2">
											...
											<input
												...
												onChange={(e) =>
													setCreate({ ...create, filament_material: e.target.value })
												}
												className="mt-1 focus:rin
                        g-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
											/>
								...
								<main>
									<div className=" mx-auto py-6 sm:px-6 lg:px-8">
										<div className="px-4 py-6 sm:px-0">
											<UploadDialog setCreate={setCreate} create={create} />
										</div>
									</div>
								</main>
							</div>
