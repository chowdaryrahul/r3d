					...
					<div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
						...
						<div className="px-4 py-6 sm:px-0">
							<div className="flex flex-col px-6 py-12 items-center border-4 border-dashed border-gray-200 rounded-lg h-96 ">
								...
								<label class="bg-white px-4 h-9 inline-flex items-center rounded border border-gray-300 shadow-sm text-sm font-medium text-gray-700 focus-within:ring-2 ring-offset-2 ring-indigo-500">
									select Image
									<input type="file" name="file" multiple class="sr-only"></input>
								</label>
								<p class=" mb-4  px-4 py-6 text-xs text-gray-600">Image type : png,Jpeg,ico</p>
							</div>
						</div>
