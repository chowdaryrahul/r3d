...
const ADD_COMMENT = gql`
	mutation ($_id: ID, $user_id: String, $user_name: String, $comt_text: String) {
		commentItem(_id: $_id, user_id: $user_id, user_name: $user_name, comt_text: $comt_text) {
			_id
			title
			likeDetails {
				user_id
...
const REMOVE_COMMENT = gql`
	mutation ($_id: ID, $user_id: String, $user_name: String, $comt_text: String) {
		uncommentItem(_id: $_id, user_id: $user_id, user_name: $user_name, comt_text: $comt_text) {
			_id
			title
			likeDetails {
				user_id
...
const LIKE_ITEM = gql`
	mutation ($_id: ID, $user_id: String, $user_name: String, $totalLikes: Int) {
		likeItem(_id: $_id, user_id: $user_id, user_name: $user_name, totalLikes: $totalLikes) {
			_id
			title
			likeDetails {
				user_id
...
const UNLIKE_ITEM = gql`
	mutation ($_id: ID, $user_id: String, $user_name: String, $totalLikes: Int) {
		unlikeItem(_id: $_id, user_id: $user_id, user_name: $user_name, totalLikes: $totalLikes) {
			_id
			title
			likeDetails {
				user_id
...
const ADD_TO_CART = gql`
	mutation ($_id: String, $user_name: String, $item_id: String, $quantity: Int) {
		addToCart(_id: $_id, user_name: $user_name, item_id: $item_id, quantity: $quantity) {
			_id
			user_name
			password
			email
...
const REMOVE_FROM_CART = gql`
	mutation ($_id: String, $item_id: String, $quantity: Int, $user_name: String) {
		removeFromCart(_id: $_id, item_id: $item_id, quantity: $quantity, user_name: $user_name) {
			_id
			user_name
			password
			email
